[[!meta title="LinuxTag in Karlsruhe cont'd"]]
...
<p>
This morning, I took the level 101 LPI exam. The questions were mostly simple
("name a command that lists all PCI devices"), but some were outdated (USB on
Linux 2.2) or wrong (the command "export set DISPLAY=:0.1" does not really make
sense). The results will only be available in a few weeks, but I'm sure I
passed even without any training before.
