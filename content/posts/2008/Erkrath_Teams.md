...
After a bit over half a year of having moved, I finally took the opportunity to play
...
evening started with a friendly "Oh, you are Christoph :)" at the entrance.

Bridge-wise the event wasn't very spectacular, just a teams tourney with the
...
We had the feeling we started well, and reached the final round, but then lost
...
from the first round. Thanks to Uschi for the good Bridge start here :)
