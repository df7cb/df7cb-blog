...
The new "Open in web" feature will send the current hand to bridgebase online's
handviewer to share with other on the web. The parallelized parscore
computation (if you have multiple CPUs) has been improved, thanks to Bo's work
